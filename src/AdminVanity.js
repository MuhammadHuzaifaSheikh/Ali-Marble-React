...
class AdminVanity extends Component {
    ...
    handleUpload = () => {
        ...
        var uploadTask = storage.ref().child(`vanity/${this.state.blobs.name}`).put(this.state.blobs);
        ...
        uploadTask.on('state_changed', (snapshot) => {
            ...
            uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
                ...
                db.collection("vanity").add({
                    imageUrl: this.state.url,
                    imageName: `vanity/${this.state.blobs.name}`,
                }).then(() => {
    ...
    deleteImages=(item)=>{
        console.log(item.id);
        db.collection("vanity").doc(item.id).delete().then(()=> {
        ...
        return (
            ...
            <div className="center">
                ...
                <div className="file-field input-field">
                    <div className="btn">
                        <span>File</span>
                        <Check imageType={16/9} blob={this.blob}/>
                    </div>
