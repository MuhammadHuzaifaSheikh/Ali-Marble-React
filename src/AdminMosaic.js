...
class AdminMosaic extends Component {
    ...
    handleUpload = () => {
        ...
        var uploadTask = storage.ref().child(`mosaic/${this.state.blobs.name}`).put(this.state.blobs);
        ...
        uploadTask.on('state_changed', (snapshot) => {
            ...
            uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
                ...
                db.collection("mosaic").add({
                    imageUrl: this.state.url,
                    imageName: `mosaic/${this.state.blobs.name}`,
                }).then(() => {
    ...
    deleteImages=(item)=>{
        console.log(item.id);
        db.collection("mosaic").doc(item.id).delete().then(()=> {
        ...
        return (
            ...
            <div className="center">
                ...
                <div className="file-field input-field">
                    <div className="btn">
                        <span>File</span>
                        <Check imageType={2/2} blob={this.blob}/>
                    </div>
